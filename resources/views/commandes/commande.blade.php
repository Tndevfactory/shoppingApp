...
@section('content')
    ...
    <div class="container">
       ...
       @include('components.breadcrumb', ['current_page'=> 'Commande'])
                        ...
                        <tr class="">
                            ...
                            <td>
                                <div class="input-group d-flex justify-content-center">
                                    ...
                                    <input type="text" class=" text-center" style="border: 1px #ddd solid"
                                           value="{{$row->qty }} " title="">
            ...
            <div class="col-2 ">
              @if (Cart::count() > 0)
                <table class="table  table-striped mt-2 shadow-sm">
                    <thead class="bg-dark bg-opacity-50 bg-gradient">
                    <tr class=" text-white">
                        <th colspan="5">Commande n°
                            0f4228ac-bdf5-4 {{-- Str::limit( Str::uuid()->toString(), 15) --}}
                        </th>
                    </tr>
                    </thead>
                    <tbody class="table-light">
                    ...
                    <tr>
                        <td colspan="">Quantite</td>
                        <td colspan="3"><span>  {{Cart::count()}} </span></td>
                    </tr>

                    <tr>
                        <td colspan="3">Total <span class="text-muted">(HT)</span></td>
                        <td colspan="2">
                    ...
                    <form action="{{ route('paiment-proceed') }}" method="POST">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="radio" name="paiment" value="bancaire" > Bancaire
                        </td>
                    </tr>
